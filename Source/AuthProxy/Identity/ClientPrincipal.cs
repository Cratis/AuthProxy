...
public class ClientPrincipal
{
    ...
    /// <summary>
    /// Attempts to deserialize a <see cref="ClientPrincipal"/> from a base64-encoded header value.
    /// </summary>
    /// <param name="base64">The base64-encoded JSON string to deserialize.</param>
    /// <param name="principal">The deserialized <see cref="ClientPrincipal"/>, or <see langword="null"/> when unsuccessful.</param>
    ...
    /// <summary>
    /// Serializes the principal to a UTF-8 JSON byte array.
    /// </summary>
