...
/// competition. With a single service the proxy also emits <c language="text">/{**catch-all}</c> carrying the
...
/// <c language="text">appsettings.Development.json</c> is where it is declared.
/// </para>
/// </summary>
