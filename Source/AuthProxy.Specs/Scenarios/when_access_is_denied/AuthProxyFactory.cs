...
namespace Cratis.AuthProxy.Scenarios.when_access_is_denied;

/// <summary>
/// WebApplicationFactory that configures the identity backend to return 403 Forbidden,
/// causing IdentityMiddleware to serve the access-denied error page.
/// </summary>
public class AuthProxyFactory : WebApplicationFactory<Program>
{
    ...
    public AuthProxyFactory()
    {
        ...
        File.WriteAllText(Path.Combine(_pagesPath, "403.html"), "<html><body><h1>Access Denied</h1></body></html>");
    }
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            // Identity backend returns 403 — simulates a user who is authenticated but not authorized.
