...
/// <summary>
/// A sealed record that names a challenge but no transaction is refused, so the transaction half of the
...
/// </remarks>
public class and_only_the_challenge_is_present : Specification
{
