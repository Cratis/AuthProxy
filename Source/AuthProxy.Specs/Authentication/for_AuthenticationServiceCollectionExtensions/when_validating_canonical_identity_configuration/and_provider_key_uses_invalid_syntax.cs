...
/// <summary>
/// Specifies that a canonical provider key containing characters outside the lowercase ASCII contract is rejected.
/// </summary>
public class and_provider_key_uses_invalid_syntax : given.canonical_configuration_validation
{
    IServiceProvider _services = null!;
    Exception? _exception;

    void Establish() => _services = BuildServices(ValidOidcProvider(providerKey: "Workforce"));
