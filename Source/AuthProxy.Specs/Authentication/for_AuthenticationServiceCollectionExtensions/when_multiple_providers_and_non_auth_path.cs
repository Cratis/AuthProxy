...
public class when_multiple_providers_and_non_auth_path : Specification
{
    const string RequestPath = "/products/list";
    ...
    [Fact] void should_redirect_to_select_provider_page_with_encoded_return_url() =>
        _redirectContext.Response.Headers.Location.ToString()
            .ShouldEqual("/.cratis/select-provider?returnUrl=%2Fproducts%2Flist%3Fcategory%3Dbooks");
}
