...
/// the identity provider's login page as a <c language="text">200</c>, so the rejection is again invisible.
/// <para>
/// A caller that is not navigating gets <c language="text">401</c> instead, which is the answer it can actually act on.
