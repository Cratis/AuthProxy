...
public class when_a_signed_invitation_has_no_recipient_mode : a_recipient_mode_capability
{
    bool _accepted;

    void Because() => _accepted = InviteMiddleware.TryResolveRecipientMode(Capability(), "email", out _);
