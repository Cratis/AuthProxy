...
/// <summary>
/// A name with no Latin characters at all — nothing survives a transliteration or a Latin-1 widening, so
/// only an encoding that carries the whole of Unicode is honest here.
/// </summary>
public class and_it_is_cyrillic : Specification
{
    const string Value = "Ольга Иванова";
