...
/// <summary>
/// Specifies that duplicate canonical claims cannot reuse a canonical authorization.
/// </summary>
public class with_a_duplicate_reserved_claim : a_recorded_canonical_authorization
{
    bool _result;
