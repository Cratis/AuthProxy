...
/// <summary>
/// Specifies that case-varied reserved claim names cannot reuse a canonical authorization.
/// </summary>
public class with_a_case_varied_reserved_claim : a_recorded_canonical_authorization
{
    bool _result;
