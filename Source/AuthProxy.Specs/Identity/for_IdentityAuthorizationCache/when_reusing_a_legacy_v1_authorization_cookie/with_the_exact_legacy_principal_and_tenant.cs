...
/// <summary>
/// Specifies that an unexpired version-one cookie accepts its exact legacy principal and tenant.
/// </summary>
public class with_the_exact_legacy_principal_and_tenant : a_legacy_v1_authorization_cookie
{
    bool _result;
