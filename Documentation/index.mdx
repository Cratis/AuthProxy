...
<CardGrid>
  ...
  <SimpleCard title="Multi-tenancy" icon="seti:db" link="/authproxy/configuration/tenancy/">
  ...
  <SimpleCard title="Invites &amp; lobby" icon="open-book" link="/authproxy/configuration/lobby/">
...
<CardGrid>
  <SimpleCard title="Configuration reference" icon="rocket" link="/authproxy/configuration/">
    The complete `Cratis:AuthProxy` settings shape, service routing, and every topic below it.
  </SimpleCard>
  <SimpleCard title="Aspire hosting" icon="seti:config" link="/authproxy/aspire/">
